...
#Projected goal: Create an application that sends push notifications // daily reports for securities that have a high likelyhood of being a good short term trade.
